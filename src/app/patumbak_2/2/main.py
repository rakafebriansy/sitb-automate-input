...
# ---------- Config ----------
FILE_NAME = "data/patumbak_2/1/clean_SD Swasta PAB 22 Patumbak I.xlsx"
STATE_FILE = "data/patumbak_2/1/state.json"
ITERATE = None
...
if not os.path.exists(FILE_NAME):
    ...
    for idx in range(start_index, iterate_count):
        ...
        jk = str(row.get("jenis_kelamin_id", str(random.randint(1,2)))).strip()

        # default BB/TB with random ±5 variation
        if jk == "1":
            bb = random.randint(50, 60)
            tb = random.randint(155, 165)
        else:
            bb = random.randint(60, 70)
